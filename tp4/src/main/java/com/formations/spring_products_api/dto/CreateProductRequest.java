...
public record CreateProductRequest(
	...
	@Size(
		max = 1000,
		message = "La description ne doit pas dépasser {max} caractères"
	)
	String description,
	...
	@DecimalMin(
		value = "0.01",
		message = "Le prix doit être au minimum de {value}"
	)
	@Digits(
		integer = 8,
		fraction = 2,
		message = "Le prix doit avoir au maximum {integer} chiffres entiers et {fraction} décimales"
	)
	BigDecimal price,
